...
class DependentFilteredEntityType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $options['level_property'] = $entities[$options['entity_alias']]['level_property'];
        ...
        $builder->setAttribute('level_property', $options['level_property']);
        $builder->setAttribute('fallback_parent_field', $options['fallback_parent_field']);
        $builder->setAttribute('entity_alias', $options['entity_alias']);
        $builder->setAttribute('level', $options['level']);
    ...
    {
        $view->vars['value'] = $form->getData() ? $form->getData()->getId() : '';
        ...
        $view->vars['level_property'] = $form->getConfig()->getAttribute('level_property');
        $view->vars['level'] = $form->getConfig()->getAttribute('level');
